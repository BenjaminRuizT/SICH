...
const ITEMS = [
  ...
  { to: '/admin/importar', label: '📥 Importar datos', desc: 'Cargar MAF y plantilla de empleados' },
];
  ...
  return (
    <div className="md:ml-56 space-y-4">
      ...
      <div className="grid gap-3">
        {ITEMS.map(item => (
          <NavLink key={item.to} to={item.to} className="card flex items-center gap-4 hover:border-brand-300 hover:shadow-md transition-all">
