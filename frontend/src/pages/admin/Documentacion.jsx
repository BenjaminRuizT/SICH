        ...
        <Section num={2} title="Stack Tecnológico">
          <Table
            ...
            rows={[
              ...
              ['Generación de PDF (ZIP)', 'puppeteer-core + Chromium', 'v25.4 — renderiza cartas HTML a PDF server-side para exportación masiva'],
              ['Empaquetado ZIP', 'archiver', 'v7.0 — genera archivos ZIP en streaming con múltiples PDFs y Excel'],
        ...
        <Section num={4} title="Módulos Funcionales">
          <Table
            ...
            rows={[
              ...
              ['Historial', 'Consulta, búsqueda y filtrado de revisiones registradas. El administrador puede eliminar registros individuales (CASCADE: elimina revision_auto y revision_equipo).', <Badge color="blue">Todos</Badge>],
              ...
              ['Exportar ZIP Responsivas', 'Generación asíncrona de ZIP con cartas responsivas (auto y/o equipo) en PDF por empleado + hoja Excel de resumen. El job persiste en sessionStorage: navegar o refrescar la página no cancela la exportación.', <Badge color="blue">Configurado por admin</Badge>],
        ...
        <Section num={7} title="Endpoints de API">
          <Table
            ...
            rows={[
              ...
              [<Badge color="teal">PATCH</Badge>, '/api/revisiones/:id', <Badge color="blue">Auth</Badge>, 'Actualizar estado, observaciones o firma_rh_pendiente de una revisión'],
              [<Badge color="red">DELETE</Badge>, '/api/revisiones/:id', <Badge color="amber">Admin</Badge>, 'Eliminar revisión y sus datos asociados (CASCADE: revision_auto + revision_equipo)'],
              ...
              [<Badge color="green">POST</Badge>, '/api/responsivas/generar', <Badge color="blue">Configurado</Badge>, 'Inicia job asíncrono de generación ZIP (params: tipo=auto|equipo|ambos, desde, hasta). Retorna jobId.'],
              [<Badge color="blue">GET</Badge>, '/api/responsivas/estado/:jobId', <Badge color="blue">Configurado</Badge>, 'Consulta progreso del job (status: pending | processing | ready | error, current, total)'],
              [<Badge color="blue">GET</Badge>, '/api/responsivas/descargar/:jobId', <Badge color="blue">Configurado</Badge>, 'Descarga el ZIP generado (PDFs por empleado + Excel de resumen). Job expira en 1 hora.'],
              ...
              {[
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'Banner automático al detectar nueva versión (polling /api/version cada 5 min)',
                    'Jobs de exportación ZIP persisten en sessionStorage (navegar o refrescar no cancela el job)',
                  ]
                },
