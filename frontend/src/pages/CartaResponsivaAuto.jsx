...
function blank(val) {
  return val || '________________________________';
}
          ...
          <table className="w-full border-collapse border border-gray-800 mb-6 text-xs">
            <tbody>
              <tr>
                ...
                <td className="border border-gray-800 text-[10px] px-2 py-0.5">CAMBIOS:</td>
              </tr>
              <tr>
        ...
        <div className="bg-white shadow-md print:shadow-none p-10 print:p-8">
          ...
          <div className="text-xs leading-relaxed font-serif">
            <ol start="4" className="space-y-2 list-decimal pl-5">
              ...
              <li>Se deberá establecer un programa de mantenimiento preventivo que asegure la operación cotidiana y alargue la vida útil de automóvil, será responsabilidad de "el empleado" que tiene asignado el automóvil el estado y conservación del mismo y sujetarse totalmente a lo que "la empresa" establezca, el gasto máximo establecido para este concepto será el establecido en la política de automóviles vigentes en la misma, previa presentación de comprobantes.</li>
            ...
            <div className="mt-4 p-3 bg-gray-50 border border-gray-300 rounded text-xs space-y-1">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                ...
                <span>Póliza: <strong>{auto.poliza_seguro || '—'}</strong></span>
                <span>Licencia: <strong>{auto.licencia_numero || '—'}</strong></span>
                <span>Llanta refacción: <strong>{auto.llanta_refaccion == null ? '—' : auto.llanta_refaccion ? 'Sí' : 'No'}</strong></span>
                <span>Revisión: <strong>{fmt(rev.fecha_revision)}</strong></span>
              </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-8">
              <div className="text-center">
                {auto.firma_empleado
                  ? <img src={auto.firma_empleado} alt="Firma empleado" className="h-20 mx-auto border-b border-gray-400 mb-1" />
                  : <div className="h-20 border-b border-gray-400 mb-1" />
                }
                <p className="text-[11px] font-semibold">Nombre y Firma del Empleado</p>
                <p className="text-[11px] text-gray-600">{nombreEmp}</p>
              </div>
              <div className="text-center">
                {auto.firma_auditor
                  ? <img src={auto.firma_auditor} alt="Firma auditor" className="h-20 mx-auto border-b border-gray-400 mb-1" />
                  : <div className="h-20 border-b border-gray-400 mb-1" />
                }
                <p className="text-[11px] font-semibold">RH de la Unidad de Negocio</p>
                <p className="text-[11px] text-gray-600">{rev.auditor_nombre || '—'}</p>
              </div>
            </div>
          </div>
