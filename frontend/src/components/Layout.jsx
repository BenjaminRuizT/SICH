...
function MiFirmaModal({ nombre, onClose }) {
...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {showFirmaModal && <MiFirmaModal nombre={user?.nombre} onClose={() => setShowFirmaModal(false)} />}
      {/* Update banner */}
      {updateAvailable && (
        ...
        <div className="max-w-screen-xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Mi firma"
              className="text-xs bg-brand-800 hover:bg-brand-700 text-white px-2.5 py-1.5 rounded-lg transition-colors hidden sm:block"
            >
              ✍ Firma
            </button>
            <button
